...
<fieldset>
    <label id="first_name"><u>First Name</u></label>
    <input type="text" name="first_name" value="<?php if(isset($_POST['first_name'])) echo htmlspecialchars($_POST ['first_name']); ;?>">
<span class="error"><?php echo $first_name_Err;?></span>

    <label id="last_name"><u>Last Name</u></label>
    <input type="text" name="last_name" value="<?php if(isset($_POST['last_name'])) echo htmlspecialchars($_POST ['last_name']); ;?>">
<span class="error"><?php echo $last_name_Err;?></span>

    <label id="email"><u>Email</u></label>
    <input type="email" name="email" value="<?php if(isset($_POST['email'])) echo htmlspecialchars($_POST ['email']); ;?>">
<span class="error"><?php echo $email_Err;?></span>

<label id="phone"><u>Phone</u></label>
    <input type="tel" name="phone" placeholder="xxx-xxx-xxxx" value="<?php if(isset($_POST['phone'])) echo htmlspecialchars($_POST ['phone']); ;?>">
    <span class="error"><?php echo $phone_Err;?></span>

<label id="interest"><u>My Feedback is About:</u></label>
...
<label id="skin_type"><u>My Skin Type is</u></label>
...
<select name="skin_type">
    ...
    <label id="comments">Tell Me More</label>
