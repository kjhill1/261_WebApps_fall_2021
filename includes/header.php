...
switch ($today) {
    ...
    switch ($today) {
        case 'Friday':
            ...
            $alt = 'Feist';
            $class = 'fri';
            $content = '<a href="https://en.wikipedia.org/wiki/50_Cent"><b>Leslie Feist </b></a>, known mononymously as Feist, is a Canadian indie pop singer-songwriter and guitarist, performing both as a solo artist and as a member of the indie rock group Broken Social Scene. Feist launched her solo music career in 1999 with the release of Monarch.<br>
