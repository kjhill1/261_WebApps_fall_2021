...
<?php
 if($_SERVER ['REQUEST_METHOD'] == 'POST') {
    ...
    //     echo '<span class="error">Please enter your cars fuel efficiency </span>';
    //     $error_status = TRUE;
    // }
    ...
    // need 2 equations here: total cost for gas and miles per $ppg AND ???? # of hours driven? ????
            ...
            // HOW MANY HOURS 
            // $totalHours = $miles / 65;
            // $friendly_totalHours =  number_format($totalHours);
            // if($totalHours == 0) {
            //     $totalHours = 1;
            // }
            ...
            // $friendly_totalDays = number_format($totalDays);
